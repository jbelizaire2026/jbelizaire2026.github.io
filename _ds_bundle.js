...
})(); } catch (e) { __ds_ns.__errors.push({ path: "deploy/icons.js", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function Hero({
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: "cover",
      src: "../../assets/images/hero-family-home.jpg",
      alt: "A mother and daughter outside their St. Louis home"
    }), /*#__PURE__*/React.createElement("div", {
      className: "scrim"
    })), /*#__PURE__*/React.createElement("div", {
    ...
    }, "Your home deserves more than shortcuts"), /*#__PURE__*/React.createElement("p", {
      className: "lede",
      style: {
...
(function () {
  ...
  function Investors() {
    const tabs = [{
      ...
      before: "../../assets/images/brrrr-before-v2.jpg",
      after: "../../assets/images/brrrr-after-v2.jpg"
    }, {
      title: "Fix-and-flips",
      ...
      before: "../../assets/images/flip-hillside-before.jpg",
      after: "../../assets/images/flip-hillside-after.jpg"
    }, {
      title: "Rental rehabs",
      body: "Durable, tenant-friendly finishes that hold up and keep maintenance costs down. That's how we build rental income.",
      before: "../../assets/images/rental-rehab-before-v2.jpg",
      after: "../../assets/images/rental-rehab-after-v2.jpg"
    }];
    return /*#__PURE__*/React.createElement("section", {
      className: "section scheme-2",
      id: "investors"
  ...
  function Homeowners() {
    const items = [{
      ...
      content: /*#__PURE__*/React.createElement(HomeownerCard, {
        ...
        composed: "../../assets/images/bathroom-before-after.jpg"
      })
    }, {
      value: "s",
      label: "Basements",
      ...
      label: "Porches & decks",
      content: /*#__PURE__*/React.createElement(HomeownerCard, {
        eyebrow: "Porches & decks",
        title: "Built for the outdoors",
        body: "New builds, rebuilds, and refinishing that bring tired wood back to life \u2014 ready for years of weekends outside.",
        composed: "../../assets/images/deck-before-after.jpg"
      })
    }, {
      value: "r",
      label: "Roofs & gutters",
      content: /*#__PURE__*/React.createElement(HomeownerCard, {
        ...
        title: "Protect what's underneath",
        body: "Full roof replacements and gutter work that keep water out and protect everything below. Done right, done to last.",
        composed: "../../assets/images/roof-before-after.jpg"
      })
    }];
    return /*#__PURE__*/React.createElement("section", {
  ...
  function HomeownerCard({
    ...
    let media;
    if (before && after) {
      media = /*#__PURE__*/React.createElement(BeforeAfter, {
        before: before,
        after: after,
        alt: title
      });
...
(function () {
  ...
  function VideoCard({
    ...
    const videoId = mode === "before" ? before : after;
    return /*#__PURE__*/React.createElement("div", {
      className: "rounded-img rc-video",
      onClick: () => onPlay(videoId, title + " \u2014 " + (mode === "before" ? "Before" : "After")),
      style: {
        position: "relative",
        overflow: "hidden",
        cursor: "pointer"
  ...
  function VideoLightbox({
    ...
    }, video.label), /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      "aria-label": "Close",
      style: {
        border: "none",
  ...
  function Gallery() {
    const [video, setVideo] = useS3(null);
    const projects = [{
      before: "ugJhHvTgNcI",
      after: "bk-TReBfO8o",
      title: "3316 Sidney",
      meta: "Full rehab · Before & after"
    }, {
      before: "rVhfRrlIMwc",
      after: "6QSygXUM5zc",
      title: "4315 Delmar",
  ...
  function Process() {
    return /*#__PURE__*/React.createElement("section", {
      ...
      img: "../../assets/images/discovery-call-couple.jpg"
    }), /*#__PURE__*/React.createElement("div", {
      className: "grid cols-2"
    }, /*#__PURE__*/React.createElement(ProcessCard, {
      step: "Step 02",
      ...
      img: "../../assets/images/site-visit-couple.jpg"
    }), /*#__PURE__*/React.createElement(ProcessCard, {
      step: "Step 03",
      title: "Scope & budget",
      body: "Detailed proposal. Fixed price. You approve up front.",
      img: "../../assets/images/scope-budget-review.jpg"
    }), /*#__PURE__*/React.createElement(ProcessCard, {
      step: "Step 04",
      title: "Construction",
      body: "We build it. Weekly updates. Same-day answers given.",
      img: "../../assets/images/construction-framing.jpg"
    }), /*#__PURE__*/React.createElement(ProcessCard, {
      step: "Step 05",
      title: "Walkthrough",
      body: "We inspect together. You sign off. The work's done.",
      img: "../../assets/images/walkthrough-inspect.jpg"
    })))));
  }
...
(function () {
  ...
  const ContactForm = fwdRef(function ContactForm(_props, ref) {
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      src: "../../assets/images/contact-couple-home.jpg",
      alt: "A happy couple in front of their renovated St. Louis home"
